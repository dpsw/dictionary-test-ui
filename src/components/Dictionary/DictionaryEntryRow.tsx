...
export const DictionaryEntryRow: React.FC<DictionaryEntryRowProps> = ({ 
  ...
  return (
    <div 
      className="card animate-fade-in overflow-visible cursor-pointer hover:shadow-lg transition-shadow"
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center">
              ...
              {entry.pronunciation && (
                <span className="ml-2 text-gray-500 text-sm">/{entry.pronunciation}/</span>
              )}
              <span className="ml-2 badge-secondary text-xs">
                {entry.partOfSpeech}
              </span>
            </div>
              ...
              <div className="space-y-3">
                ...
                {entry.examples.length > 3 && (
                  <p className="text-sm text-gray-500 pl-4">
                    +{entry.examples.length - 3} more examples
                  </p>
                )}
              </div>
            )}
